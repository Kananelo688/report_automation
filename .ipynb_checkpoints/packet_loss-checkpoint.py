...
def compile_report(filename_4G_stats, filename_3G_stats,destination_filename = 'Packetloss.xlsx',verbose = False):
    """
    Computes Packet Loss Report, given 4G and 3G statistics filenames(.xlsx files).
    ...
    if verbose:
        print('Load files...',end= '', flush = True)
...
def main(verbose=True):
    file_3G = input('Enter filename of the 3G stats:\n')
    file_4G = input('Enter filename of the 4G stats:\n')
    compile_report(file_4G, file_3G,verbose)
